...
public class BinaryLogClientIntegrationTest {
    ...
    private static final long DEFAULT_TIMEOUT = TimeUnit.SECONDS.toMillis(300);
    ...
    private static CountDownEventListener eventListener;
...
//        assertEquals(writeAndCaptureRow("tinyint unsigned", "0", "1", "255"), new Serializable[]{0, 1, -1});
//        assertEquals(writeAndCaptureRow("tinyint", "-128", "-1", "0", "1", "127"), new Serializable[]{-128, -1, 0, 1, 127});
//        assertEquals(writeAndCaptureRow("bool", "1"), new Serializable[]{1});
    }


    public void testDeserializationOfSHORT() throws Exception {
//        assertEquals(writeAndCaptureRow("smallint unsigned", "0", "1", "65535"), new Serializable[]{0, 1, -1});
//        assertEquals(writeAndCaptureRow("smallint", "-32768", "-1", "0", "1", "32767"), new Serializable[]{-32768, -1, 0, 1, 32767});
    }

    public void testDeserializationOfINT24() throws Exception {
//        assertEquals(writeAndCaptureRow("mediumint unsigned", "0", "1", "16777215"), new Serializable[]{0, 1, -1});
//        assertEquals(writeAndCaptureRow("mediumint", "-8388608", "-1", "0", "1", "8388607"), new Serializable[]{-8388608, -1, 0, 1, 8388607});
    }
