...
#### Configuration management<span id = "jump">跳转到的位置</span>
...
|--------------------------------------------------------------------|-------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cdc/master/instance_admin/config/app/mysql/host                    | 10.0.0.1          | Yes          | Database host ip                                                                                                                                                  |
| cdc/master/instance_admin/config/app/mysql/port                    | 3300              | Yes          | Database port                                                                                                                                                     |
| cdc/master/instance_admin/config/app/mysql/username                | Admin             | Yes          | Database username                                                                                                                                                 |
| cdc/master/instance_admin/config/app/mysql/password                | 123               | Yes          | Database password                                                                                                                                                 |
| cdc/master/instance_admin/config/app/rabbitmq/host                 | 10.0.0.1,10.0.0.2 | Optional     | Rabbitmqcluster host ip (comma separated) if you use rabbitmq required                                                                                            |
| cdc/master/instance_admin/config/app/rabbitmq/port                 | 4567              | Optional     | Rabbitmq cluster port (only support cluster port is the same when multiple clusters are configured )                                                              |
| cdc/master/instance_admin/config/app/rabbitmq/username             | Admin             | Optional     | Rabbitmq cluster username                                                                                                                                         |
| cdc/master/instance_admin/config/app/rabbitmq/password             | 123               | Optional     | Rabbitmq cluster password                                                                                                                                         |
| cdc/master/instance_admin/config/app/rabbitmq/vhost                | Core              | Optional     | Rabbitmq cluster Virtual host                                                                                                                                     |
| cdc/master/instance_admin/config/app/rabbitmq/exchangename         | Cdc               | Optional     | Rabbitmq cluster exchange name                                                                                                                                    |
| cdc/master/instance_admin/config/cdc/connection_timedout_inseconds | 10                | no           | Cdc and mysql connection timeout (default 10s)                                                                                                                    |
| cdc/master/instance_admin/config/cdc/ping_failed_max_retry         | 50                | no           | Cdc and mysql retry connections                                                                                                                                   |
| cdc/master/instance_admin/config/cdc/mysqlTimeZone                 | GMT+8             | no           | We will convert the datatime to a timestamp and add the mysql time zone ( time zone abbreviation such as CST is not allowed . There will be time zone confusion ) |
| cdc/master/instance_admin/config/cdc/seqfilter/admin/user          | 1                 | Optional     | Send the table in order, admin.user configuration, where the value is fixed to 1                                                                                  |
| cdc/master/instance_admin/config/cdc/filter/admin/role             | 1                 | Optional     | Non-sequential sending table, admin. roleconfiguration, where value is fixed to 1                                                                                 |
| cdc/master/instance_admin/config/cdc/filter/admin/orders_{suffix}  | 1                 | Optional     | Non-sequential delivery table, admin.orders_{suffix } tableconfiguration, where value is fixed to 1                                                               |
...
| **Key**                                           | **Value**        | **meaning**                                                                                                                                                                                                              |
|---------------------------------------------------|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cdc/master/instance_admin/serverid                | 65535            | [server id](https://dev.mysql.com/doc/refman/5.6/en/replication-options.html) Automatically generated, the same instance is opened in multiple clusters, this value is guaranteed not to conflict                        |
| cdc/master/instance_admin/binlogfile/name         | mysql-bin.000002 | Binlog file name                                                                                                                                                                                                         |
| cdc/master/instance_admin/binlogfile/pos          | 114269237        | Binlog file postion                                                                                                                                                                                                      |
| cdc/master/instance_admin/register/administor/123 | 1 or 2           | 1 indicates that the registration is successful, 2 indicates that the lock is successfully acquired, and the status is conveniently monitored by the set value. Hostname + pid to uniquely identify the registration key |
| cdc/master/instance_admin/lock/6f4e62f6aa254dbc   | no               | Lock key                                                                                                                                                                                                                 |
...
value:cdc/master/instance_admin/config/cdc/filter/admin/right 1.
