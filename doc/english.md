...
| cdc/master/admin/config/cdc/ping_failed_max_retry         | 50                | no           | Cdc and mysql retry connections (default 50 times)                                                                                                                               |
| cdc/master/admin/config/cdc/mysqlTimeZone                 | GMT+8             | no           | We will convert the datatime to a timestamp and add the mysql time zone ( time zone abbreviation such as CST is not allowed. There will be time zone confusion ) (default GMT+8) |
