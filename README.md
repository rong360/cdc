...
A mysql binlog parser,which has running stable for more then 36 months in our production envireonment on more than 10 mysql instances . It transform binlog event(insert/delete/update) into json format data into rabbitmq or other mq(such as kafka), Based on this project:https://github.com/shyiko/mysql-binlog-connector-java.
## What is cdc?
